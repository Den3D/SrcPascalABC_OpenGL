...
begin
  Gl.glBindTexture(Gl.GL_TEXTURE_2D, Tex);
  GL.glBegin(GL.GL_QUADS);
  Gl.glTexCoord2f(0, 0.2);  gl.glVertex3f( -2.0,  2.0,  0.0); // 1
  Gl.glTexCoord2f(0, 0);  gl.glVertex3f( -2.0, -2.0,  0.0); // 2 
  Gl.glTexCoord2f(0.2, 0);  gl.glVertex3f(  2.0, -2.0,  0.0); // 3
  Gl.glTexCoord2f(0.2, 0.2);  gl.glVertex3f(  2.0,  2.0,  0.0); // 4
  GL.glEnd();
end;
