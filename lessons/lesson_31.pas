...
begin
  ...
  GL.glBegin(GL.GL_QUADS);
  Gl.glTexCoord2f(0, 0); gl.glVertex3f(-size,  size, size); // 1
  Gl.glTexCoord2f(0, 1); gl.glVertex3f(-size, -size, size); // 2 
  Gl.glTexCoord2f(1, 1); gl.glVertex3f( size, -size, size); // 3
  Gl.glTexCoord2f(1, 0); gl.glVertex3f( size,  size, size); // 4
  GL.glEnd();
  ...
  GL.glBegin(GL.GL_QUADS);
  Gl.glTexCoord2f(0, 0); gl.glVertex3f( size,  size, -size); // 5
  Gl.glTexCoord2f(0, 1); gl.glVertex3f( size, -size, -size); // 6
  Gl.glTexCoord2f(1, 1); gl.glVertex3f(-size, -size, -size); // 7
  Gl.glTexCoord2f(1, 0); gl.glVertex3f(-size,  size, -size); // 8
  GL.glEnd();
  ...
  Gl.glTexCoord2f(0, 0); gl.glVertex3f(-size,  size, -size); // 5
  Gl.glTexCoord2f(0, 1); gl.glVertex3f(-size, -size, -size); // 6
  Gl.glTexCoord2f(1, 1); gl.glVertex3f(-size, -size,  size); // 2 
  Gl.glTexCoord2f(1, 0); gl.glVertex3f(-size,  size,  size); // 1
  GL.glEnd();
  ...
  GL.glBegin(GL.GL_QUADS);
  Gl.glTexCoord2f(0, 0); gl.glVertex3f(size,  size, size); // 7
  Gl.glTexCoord2f(0, 1); gl.glVertex3f(size, -size, size); // 8
  Gl.glTexCoord2f(1, 1); gl.glVertex3f(size, -size, -size); // 4    
  Gl.glTexCoord2f(1, 0); gl.glVertex3f(size,  size, -size); // 3
  GL.glEnd();
  ...
  GL.glBegin(GL.GL_QUADS);
  Gl.glTexCoord2f(0, 0); gl.glVertex3f(-size, size,  size); // 1
  Gl.glTexCoord2f(0, 1); gl.glVertex3f( size, size,  size); // 4    
  Gl.glTexCoord2f(1, 1); gl.glVertex3f( size, size, -size); // 8
  Gl.glTexCoord2f(1, 0); gl.glVertex3f(-size, size, -size); // 5
  GL.glEnd();
  ...
  GL.glBegin(GL.GL_QUADS);
  Gl.glTexCoord2f(0, 0); gl.glVertex3f( size, -size,  size); // 3
  Gl.glTexCoord2f(0, 1); gl.glVertex3f(-size, -size,  size); // 2  
  Gl.glTexCoord2f(1, 1); gl.glVertex3f(-size, -size, -size); // 6
  Gl.glTexCoord2f(1, 0); gl.glVertex3f( size, -size, -size); // 7
  GL.glEnd();
  
  {
    Tex1 := LoadTextere('data\skybox\skybox1\bk.png');
  Tex2 := LoadTextere('data\skybox\skybox1\dn.png');
  Tex3 := LoadTextere('data\skybox\skybox1\ft.png');
  Tex4 := LoadTextere('data\skybox\skybox1\lf.png');
  Tex5 := LoadTextere('data\skybox\skybox1\rt.png');
  Tex6 := LoadTextere('data\skybox\skybox1\up.png');
  }
